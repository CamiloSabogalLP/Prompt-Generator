...
columna Automatizable: true o false baja las dos opciones y que el usuario final elija
columna Test-Type:  UI o API baja las dos opciones y que el usuario final elija
